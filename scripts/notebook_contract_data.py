...
RUN_EXECUTION_CONTRACTS = (
    {
        "prefix": "themes/04-Autoregression/lab/solutions/runs_",
        "code_cells": 11,
        "output_cells": 9,
        "summary_marker": "GPU_RUN_SUMMARY_JSON=",
        "summary_required_keys": (
            "profile_name",
            "timed_budget_minutes",
            "timed_elapsed_minutes",
            "warmup_minutes",
            "completed_steps",
            "test_perplexity",
            "baseline_perplexity",
            "cpu_reference_perplexity",
            "success_count",
            "prompt_count",
            "mean_match_ratio",
            "baseline_pass",
    ...
    {
        "prefix": "themes/05-Full-Transformer/lab/solutions/runs_",
        "code_cells": 7,
        "output_cells": 7,
        "summary_marker": "LR05_RUN_SUMMARY_JSON=",
        "summary_required_keys": (
            "runtime_profile",
            "test_loss",
            "test_accuracy",
